    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between">
        <div className="flex-1 pr-4">
          <h2 className="text-lg font-semibold leading-tight mb-2 text-white">
            {paper.title}
          </h2>
      ...
      {[
        ...
        return (
          <button
            ...
            className={`flex items-center space-x-2 px-3 py-2 border-b-2 transition-colors whitespace-nowrap ${
              activeTab === tab.key
        ...
        <>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Button
                onClick={setReminder}
                className="bg-green-500/20 text-green-400 border border-green-400/30 hover:bg-green-500/30 w-fit"
              >
  ...
  if (isMobile) {
    return (
      <Sheet open={true} onOpenChange={onClose}>
        <SheetContent 
          side="bottom" 
          className="bg-slate-900 border-slate-700 text-white h-[90vh] overflow-y-auto"
        >
